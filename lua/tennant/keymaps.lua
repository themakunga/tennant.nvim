...
M.setup = function(prefix)
  ...
  vim.keymap.set('x', prefix .. 'l', function()
    require('tennant.reader').selection()
  end, { desc = '[tennant] ' .. translate('Read selection'), silent = true })
  ...
  local maps = {
    ...
    },
    {
      prefix .. 'l',
      function()
        require('tennant.reader').line()
      end,
      'Read current line or line range',
    },
    {
      prefix .. 'b',
      function()
